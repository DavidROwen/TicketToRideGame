...
public class GameMap {
    ...
    private void initRoutes() {
        ...
        routes.put("seattle_calgary", new Route("seattle_calgary",new City("seattle"), new City("portland"), 4, TrainCard.TRAIN_TYPE.WILD));
        ...
        routes.put("pheonix_santaFe", new Route("pheonix_santaFe",new City("pheonix"), new City("santFe"), 3, TrainCard.TRAIN_TYPE.WILD));
        ...
        routes.put("santaFe_denver", new Route("santaFe_denver",new City("santFe"), new City("denver"), 2, TrainCard.TRAIN_TYPE.WILD));
        ...
        routes.put("helena_duleth", new Route("helena_winnipeg",new City("helena"), new City("duluth"), 6, TrainCard.TRAIN_TYPE.ORANGE));
        ...
        routes.put("elPaso_houston", new Route("elPaso_houston",new City("elPaso"), new City("housten"), 6, TrainCard.TRAIN_TYPE.GREEN));
        ...
        routes.put("dallas_houston_first", new Route("dallas_houston_first",new City("dallas"), new City("housten"), 1, TrainCard.TRAIN_TYPE.WILD));
        routes.put("dallas_houston_second", new Route("dallas_houston_second",new City("dallas"), new City("housten"), 1, TrainCard.TRAIN_TYPE.WILD));
        routes.put("houston_newOrleans", new Route("houston_newOrleans",new City("housten"), new City("newOrleans"), 2, TrainCard.TRAIN_TYPE.WILD));
        routes.put("dallas_littleRock", new Route("dallas_littleRock",new City("dallas"), new City("littleRock"), 2, TrainCard.TRAIN_TYPE.WILD));
        routes.put("oklahoma_littleRock", new Route("oklahoma_littleRock",new City("oklahomaCity"), new City("littleRock"), 2, TrainCard.TRAIN_TYPE.WILD));
        routes.put("KC_saintLouis_first", new Route("KC_saintLouis_first",new City("KC"), new City("saintLouis"), 2, TrainCard.TRAIN_TYPE.BLUE));
        routes.put("KC_saintLouis_second", new Route("omaha_chicago",new City("KC"), new City("saintLouis"), 2, TrainCard.TRAIN_TYPE.PINK));
        ...
        routes.put("chicago_pittsburg_second", new Route("chicago_pittsburg_second", new City("chocago"), new City("pittsburg"), 3, TrainCard.TRAIN_TYPE.BLACK));
        ...
        routes.put("charleston_raleigh", new Route("charleston_raleigh", new City("charleson"), new City("raleigh"), 2, TrainCard.TRAIN_TYPE.WILD));
